...
public class Object_dao {
  static final String WRITE_OBJECT_SQL = "INSERT INTO orders(name, object_value) VALUES (?, ?)";

  static final String READ_OBJECT_SQL = "SELECT orders FROM java_objects WHERE id = ?";

  public static Connection getConnection() throws Exception {
    return new DBConnector(new DataSource().getDataSource()).getConnection();
  }
