 ...
 * @author adamlass
 */
@WebServlet(name = "createControl", urlPatterns = {"/createControl"})
public class createControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            ...
            response.sendRedirect("create-user.jsp?status=false");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(createControl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
